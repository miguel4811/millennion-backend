...
const handlePayPalWebhook = async (req, res) => {
    ...
    switch (webhookEvent.event_type) {
        ...
        case 'PAYMENT.SALE.COMPLETED':
            ...
            console.log(`Pago de suscripción exitoso recibido. ID de suscripción de PayPal: ${completedPayment.billing_agreement_id}`);
            try {
                ...
                if (user) {
                    ...
                    console.warn(`Usuario no encontrado para el ID de suscripción de PayPal: ${completedPayment.billing_agreement_id}`);
                }
            } catch (err) {
                console.error('Error al manejar PAYMENT.SALE.COMPLETED:', err.message);
            }
            break;
